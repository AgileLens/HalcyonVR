...
// The Haptics SDK has two backends, an OpenXR backend and an OVRPlugin backend.
//
//
...
// 2. When you create the OpenXR instance with xrCreateInstance(), include the extensions needed by
//    the SDK.
 ...
 * instance, appropriate OpenXR extensions must be enabled. The list of required extensions can be
 * retrieved via calls to haptics_sdk_get_openxr_extension().
 *
